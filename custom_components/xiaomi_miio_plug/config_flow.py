"""Config flow to configure Mijia Plug/PowerStrip component."""
import logging
...
from homeassistant.const import CONF_HOST, CONF_NAME, CONF_TOKEN, CONF_DEVICE, CONF_MAC, MAJOR_VERSION, MINOR_VERSION
...
class XiaomiPlugPowerStripFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    """Handle a Xiaomi Plug/PowerStrip config flow."""
